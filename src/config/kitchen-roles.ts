...
export const KITCHEN_ROLES: Record<
  KitchenRole,
  {
    label: string;
    description: string;
...
> = {
  owner: {
    ...
    permissions: {
      ...
      prep_lists: { view: true, create: true, edit: true, delete: true },
  ...
  chef: {
    ...
    permissions: {
      ...
      production: { view: true, create: true, edit: true, delete: true },
      prep_lists: { view: true, create: true, edit: true, delete: false },
  ...
  supervisor: {
    ...
    permissions: {
      ...
      inventory: { view: true, create: true, edit: true, delete: false },
      production: { view: true, create: true, edit: true, delete: false },
      prep_lists: { view: true, create: false, edit: false, delete: false },
