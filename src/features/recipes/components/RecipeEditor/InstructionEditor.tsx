          ...
          <div className="border-t border-gray-700 pt-4 mt-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 text-sm text-primary-400 hover:text-primary-300 bg-gray-900/50 rounded-lg p-3 border-2 border-dashed order-gray-700 hover:border-primary-400/50 transition-colors"
              >
