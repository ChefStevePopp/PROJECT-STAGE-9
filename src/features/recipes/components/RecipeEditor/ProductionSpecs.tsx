...
export const ProductionSpecs: React.FC<ProductionSpecsProps> = ({ recipe, onChange }) => {
  const handleTimeChange = (field: 'prep_time' | 'cook_time' | 'rest_time', value: number) => {
    onChange({
      [field]: value,
      total_time: (field === 'prep_time' ? value : recipe.prep_time || 0) +
      ...
      <div className="card p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-amber-500/10 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-2">
                <h4 className="text-amber-400 font-medium">Food Safety Notice</h4>
                <p className="text-sm text-gray-300">
                  Time and temperature control is critical for food safety. The danger zone (4°C-60°C / 40°F-140°F) 
                  requires strict monitoring. Always follow your local health department regulations regarding:
                </p>
          ...
          <div className="bg-gray-800/50 rounded-lg p-4">
            <h4 className="text-white font-medium mb-3">Preparation Temperature Guidelines</h4>
