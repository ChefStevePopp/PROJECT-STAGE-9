            ...
            {groups.map((group, index) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`w-8 h-8 rounded-lg bg-${group.color}-500/20 flex items-center justify-center`}
                  >
                    {group.icon === "Box" && (
                      <Box className={`w-4 h-4 text-${group.color}-400`} />
                    )}
                    {group.icon === "Tags" && (
                      <Tags className={`w-4 h-4 text-${group.color}-400`} />
                    )}
                    {group.icon === "Package" && (
                      <Package className={`w-4 h-4 text-${group.color}-400`} />
                    )}
                  </div>
                    ...
                    <>
                      ...
                      <div className="opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1">
                        {index > 0 && (
                          <button
                            onClick={() =>
                              handleMoveItem(group.id, "up", "group")
                            }
                        ...
                        {index < groups.length - 1 && (
                          <button
                            onClick={() =>
                              handleMoveItem(group.id, "down", "group")
                            }
                            className="text-gray-400 hover:text-white p-1"
                          >
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            {index > 0 && (
                              <button
                                onClick={() =>
                                  handleMoveItem(category.id, "up", "category")
                                }
                            ...
                            <button
                              onClick={() =>
                                handleDeleteItem(category.id, "category")
                              }
        ...
        <div className="bg-gray-800 rounded-xl p-4">
          ...
          {!selectedCategory ? (
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-gray-400 max-w-md">
                Choose a category from the middle column to view and manage its
                sub-categories
              </p>
            </div>
          ) : (
                      ...
                      {editingItem?.id === subCategory.id ? (
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              onClick={() =>
                                handleDeleteItem(subCategory.id, "subcategory")
                              }
                              className="text-gray-400 hover:text-red-400"
                            >
                              <Trash2 className="w-4 h-4" />
